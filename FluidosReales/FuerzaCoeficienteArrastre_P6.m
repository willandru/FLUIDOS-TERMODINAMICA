...
%% Un automóvil de 1000 kg de masa posee un coeFiciente de arrastre de 0.32 y su área frontal es de 2m^2 . Calcule:
%% a) La fuerza de arrastre que experimenta cuando va a 100 km/h.
%% b) La potencia que necesita para poder viajar a 180 km/h en una carretera horizontal. Recuerde que potencia es
% igual a F*v .
